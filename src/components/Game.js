...
// To-do:
  ...
  // DONE add CSS to make text box light pink when its not filled in
  ...
  // DONE hide the submission form & DONE most_recent_submission section when "reveal" final poem is clicked
